...
namespace ASTImpl {
    ...
    public:
        ...
        virtual double Evaluate(const SheetInterface& sheet /*добавьте сюда нужные аргументы args*/) const = 0;
    ...
    namespace {
        ...
        public:
            ...
            double Evaluate(const SheetInterface& sheet /*добавьте нужные аргументы args*/) const override {
                ...
                {
                    return -1.0 * operand_.get()->Evaluate(sheet);
                }
...
double FormulaAST::Execute(const SheetInterface& sheet/*добавьте нужные аргументы args*/) const {
    return root_expr_->Evaluate(sheet/*добавьте нужные аргументы args*/);
}
