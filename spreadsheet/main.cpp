...
namespace
{
    ...
    void TestFormulaReferencedCells()
    {
        ...
        std::cout << "----------------------------------------------------------------------------------------------------------------\n";
        auto sdf = b2c3->GetReferencedCells();
        std::cout << "----------------------------------------------------------------------------------------------------------------\n";
        std::cout << "b2c3->GetReferencedCells(): " << sdf[0].row << "," << sdf[0].col << " + " << sdf[1].row << "," << sdf[1].col << "\n";
    ...
    void TestErrorValue()
    {
     ...
     //   auto sdf = sheet->GetCell("E4"_pos)->GetValue();
...
//        auto test_value = sheet->GetCell("A1"_pos)->GetValue();
    ...
    void TestCellReferences()
    {
        ...
        sheet->SetCell("A2"_pos, ""); //ловим тут
        ASSERT(sheet->GetCell("A1"_pos)->GetReferencedCells().empty());
    ...
    void TestSetPrint() {
        ...
        std::cerr << "TestSetPrint OK" << std::endl;
    }
